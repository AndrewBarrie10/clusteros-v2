...
(function () {
  ...
  var NAV_HTML = ''
    ...
    +     '</li>'
    +     '<li class="nav-dropdown">'
    +       '<span class="nav-dropdown-toggle">Findings ▾</span>'
    +       '<ul class="nav-dropdown-menu">'
    +         '<li><a href="/findings.html">Overview</a></li>'
    +         '<li><a href="/national-diagnostic.html">UK Regional Diagnostic</a></li>'
    +         '<li><a href="/cluster-library.html">Cluster Library</a></li>'
    +       '</ul>'
    +     '</li>'
    +     '<li class="nav-dropdown">'
    ...
    +   '<a href="/national-diagnostic.html">UK Regional Diagnostic</a>'
    +   '<a href="/cluster-library.html">Cluster Library</a>'
  ...
  var BAR_HTML = ''
    ...
    +     '<span class="bar-icon">Cluster<span>OS</span></span>'
